...
public class SocialAuthStrategy implements IAuthStrategy {
    ...
    public LoginVo login(String body, RemoteClientVo client) {
        ...
        if ("GITEE".equals(authUserData.getSource())) {
            ...
            HttpUtil.createRequest(Method.PUT, "https://gitee.com/api/v5/user/starred/dromara/autoframework-Vue-Plus")
                .formStr(MapUtil.of("access_token", authUserData.getToken().getAccessToken()))
                .executeAsync();
            HttpUtil.createRequest(Method.PUT, "https://gitee.com/api/v5/user/starred/dromara/autoframework-Cloud-Plus")
                .formStr(MapUtil.of("access_token", authUserData.getToken().getAccessToken()))
                .executeAsync();
        }
