package com.autoframework.auth.controller;
...
import com.autoframework.auth.domain.vo.LoginTenantVo;
import com.autoframework.auth.domain.vo.LoginVo;
import com.autoframework.auth.domain.vo.TenantListVo;
import com.autoframework.auth.form.RegisterBody;
import com.autoframework.auth.form.SocialLoginBody;
import com.autoframework.auth.service.IAuthStrategy;
import com.autoframework.auth.service.SysLoginService;
import com.autoframework.common.core.constant.UserConstants;
import com.autoframework.common.core.domain.R;
import com.autoframework.common.core.domain.model.LoginBody;
import com.autoframework.common.core.utils.*;
import com.autoframework.common.encrypt.annotation.ApiEncrypt;
import com.autoframework.common.json.utils.JsonUtils;
import com.autoframework.common.satoken.utils.LoginHelper;
import com.autoframework.common.social.config.properties.SocialLoginConfigProperties;
import com.autoframework.common.social.config.properties.SocialProperties;
import com.autoframework.common.social.utils.SocialUtils;
import com.autoframework.common.tenant.helper.TenantHelper;
import com.autoframework.resource.api.RemoteMessageService;
import com.autoframework.system.api.RemoteClientService;
import com.autoframework.system.api.RemoteConfigService;
import com.autoframework.system.api.RemoteSocialService;
import com.autoframework.system.api.RemoteTenantService;
...
public class TokenController {
    ...
    public R<LoginVo> login(@RequestBody String body) {
        ...
        scheduledExecutorService.schedule(() -> {
            remoteMessageService.publishMessage(userId, "欢迎登录autoframework-Cloud-Plus微服务管理系统");
        }, 3, TimeUnit.SECONDS);
        return R.ok(loginVo);
    }
